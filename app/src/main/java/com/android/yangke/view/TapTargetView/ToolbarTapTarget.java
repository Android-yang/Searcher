...
class ToolbarTapTarget extends ViewTapTarget {
    ...
    private static View findOverflowView(Object instance) {
        ...
        // desired target
        try {
            final Object actionMenuView = ReflectTool.getPrivateField(toolbar.internalToolbar(), "mMenuView");
            final Object actionMenuPresenter = ReflectTool.getPrivateField(actionMenuView, "mPresenter");
            return (View) ReflectTool.getPrivateField(actionMenuPresenter, "mOverflowButton");
